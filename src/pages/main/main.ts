...
class Main {
  ...
  private addButtonToyToMain() {
    const buttonStatuette = document.createElement("button");
    buttonStatuette.className = "toy";
  ...
  render() {
    ...
    const buttonStatuette = this.addButtonToyToMain();
    ...
    shape.append(buttonBall, buttonBell, buttonCone, buttonSnowflake, buttonStatuette);
